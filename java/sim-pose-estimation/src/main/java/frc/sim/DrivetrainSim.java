...
public class DrivetrainSim {
    ...
    DifferentialDrivetrainSim drivetrainSimulator = new DifferentialDrivetrainSim(drivetrainSystem, DCMotor.getCIM(2),
            8, Constants.kTrackWidth, Constants.kWheelRadius, null);
    ...
    SimVisionSystem simVision = new SimVisionSystem(Constants.kCamName, camDiagFOV, camPitch, Constants.kCameraToRobot,
    ...
    /**
     * For testing purposes only! Applies an unmodeled, undetected offset to the
     * pose Similar to if you magically kicked your robot to the side in a way the
